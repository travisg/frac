...
*/
    ...
    'running: loop {
        ...
        // fractal routine
        if drawing {
            // draw one column of the fractal
            frac_draw_col(&mut canvas, col, window_size);
...
// render one column of the fractcal
fn frac_draw_col<T: sdl2::render::RenderTarget>(canvas : &mut sdl2::render::Canvas<T>, col : i32, window_size : (u32, u32)) {
